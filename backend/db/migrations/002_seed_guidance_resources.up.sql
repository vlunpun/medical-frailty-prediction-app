...
INSERT INTO guidance_resources (category, title, description, resource_url, applicability_criteria, priority) VALUES
  ...
  ('maintenance', 'Maintaining Your Medicaid Coverage', 'Essential steps to keep your Medicaid benefits active and avoid coverage gaps', 'https://www.in.gov/medicaid/coverage', ARRAY[], 70),
