...
```bash
git remote add encore encore://medicaid-frailty-assessment-ea3i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/medicaid-frailty-assessment-ea3i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/medicaid-frailty-assessment-ea3i/settings/integrations/github)
